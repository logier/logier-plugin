...
const Weathertime = '0 0/1 * * * ?';// 摸鱼日历定时发送时间，采用 Cron 表达式，当前默认为每日 9:00 分推送
const WeathergroupList = ["877538147"]; // 摸鱼日历指定定时发送的群号
const WeatherisAutoPush = true;// 摸鱼日历是否开启定时推送，默认为 false
